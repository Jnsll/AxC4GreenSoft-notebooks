...
dataset_size_percentages = [50, 100]
featureset_size_percentages = [50, 100]
...
def run_experiment(RQ, iteration, experiment_id, classifier_name, dataset_percentage, featureset_percentage, preprocessed_data, raw_data):
...
def run_experiment_exp(experiment_id, classifier_name, dataset_percentage, featureset_percentage, preprocessed_data, raw_data):
    classifier = CLASSIFIERS[classifier_name]
    print(f"Starting Experiment: {experiment_id},"
          f"\n classifier {classifier},"
          f"\n dataset_percentage {dataset_percentage},"
...
def run_experiment_batch(experiments, preprocessed_data, raw_data):
    ...
    with progressbar(experiments) as bar:
        for experiment in bar:
            print("\n")
            run_experiment_exp(experiment_id, classifier_name, dataset_percentage, featureset_percentage, preprocessed_data, raw_data)
